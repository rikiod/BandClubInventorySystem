...
| 4 | **Design:** | Created sketches of proposed user interface | 1 hour | Completed and viewable in the Development section | C | 
| 5 | **Planning, Design, & Development:** | Create visual user interface using QTDesigner based off of sketches and consult with client to get their opinion. | 1.5 hours | Completed -- see Development section | A, B, C |
